        ...
        <div class="row ">
            <div class="col-md-6 ">
                ...
                <label class="btn btn-secondary">
                 ...
                 <video id="preview" width="100%"   type="file"
        accept="image/*"
        capture="environment" ></video>
                <?php include 'monitoring/DTR_afternoon.php'; ?>
            ...
            <div class="col-md-6">
               ...
               <div class="table-responsive">
                <table id="dataTable_1" class="table table-bordered table-striped">
                    ...
                    $sql= "SELECT * FROM monitoring LEFT JOIN student ON student.id = monitoring.student_id WHERE monitoring.date = '$today' AND monitoring.time='Afternoon'";
