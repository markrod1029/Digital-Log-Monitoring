...
class Appointment
{
	public $base_url = 'http://localhost/dental/consultation/';
	public $connect;
	public $query;
	public $statement;
	public $now;
	...
	{
		$this->connect = new PDO("mysql:host=localhost;dbname=doctor_appointment", "appointment", "doctor_appointment");
	...
	{
		$this->query = "
		SELECT * FROM patient_table  Where status = 'Active'
		";
		$this->execute();
		return $this->row_count();
	}
