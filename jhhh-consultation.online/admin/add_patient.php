						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text"  minlength="11" maxlength="11" pattern="\d{11}" title="11-digit Phone Number" name="patient_phone_no" id="patient_phone_no" class="form-control" required  data-parsley-trigger="keyup" />
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
