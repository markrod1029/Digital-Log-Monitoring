...
if(isset($_POST["action"]))
{
	if($_POST["action"] == 'fetch')
	{
		...
		{
			$order_column = array( 'patient_table.patient_first_name', 'doctor_table.doctor_name', 'doctor_schedule_table.doctor_schedule_date','doctor_schedule_table.doctor_schedule_day');
			$main_query = "
