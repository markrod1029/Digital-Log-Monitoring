...
if(isset($_POST["action"]))
{
	if($_POST["action"] == 'fetch')
	{
		...
		foreach($result as $row)
		{
			...
			{
				$status = '<button type="button" name="status_button" class="btn btn-primary btn-sm status_button" data-id="'.$row["doctor_schedule_id"].'" data-status="'.$row["doctor_schedule_status"].'">Available</button>';
			}
			else
			{
				$status = '<button type="button" name="status_button" class="btn btn-danger btn-sm status_button" data-id="'.$row["doctor_schedule_id"].'" data-status="'.$row["doctor_schedule_status"].'">Unavailable</button>';
			}
			...
			$sub_array[] = '
			<div align="center">
			<a name="edit" href="update_availavility.php?doctor_schedule_id='.$row['doctor_schedule_id'].'" class="btn btn-warning btn-circle btn-sm" ><i class="fas fa-edit"></i></a>
			&nbsp; 
