                ...
                <?php include('include/menubar.php')  ?>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="row col-auto mb-1">
                                        <a href="doctor_schedule.php" class="btn btn-primary mr-1 active">All</a>
                                        <a href="doctor_schedule.php?status=<?php echo $row['status'] = 'Cancel'?>" class="btn btn-primary mr-1 ">Approved</a>
                                        <a href="fdoctor_schedule.php" class="btn btn-primary mr-1 ">Pending</a>
                                        <a href="doctor_schedule.php" class="btn btn-primary ">Cancelled</a>
                                    </div>
