  ...
  <h1 class="h3 mb-4 text-gray">Doctor Schedule Managment</h1>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                        	<div class="row">
                            	<div class="col">
                            		<h6 class="h3 m-0 font-weight-bold text-success">Doctor Schedule Update</h6>
                            	</div>
...
<form  class="form-horizontal box-show" method="POST" action="" enctype="multipart/form-data" id="doctor_form">
    ...
    <div class="modal-footer">
        <input type="hidden" name="ID"  value="<?php echo $_GET['doctor_schedule_id']?>"/>
...
if(isset($_POST['submit'])){
    ...
    $doctor_id = $_POST['doctor_schedule_id']; 
    $ID = $_POST['ID'];
    ...
    $average_consulting_time = $_POST['average_consulting_time'];
     ...
     $sql = "UPDATE doctor_schedule_table SET doctor_schedule_date = '$doctor_schedule_date',
