...
// WHERE doctor_schedule_table.doctor_schedule_date > $today
                    ...
                    ?>
						...
						{?>
							...
							<a  class="btn btn-primary btn-sm status_button"  href="availavility.php?status=<?php echo $row["doctor_schedule_id"] ?>" onclick="return confirm('Are you sure you want to Available it?')">Available</a>
						<?php
						}
						else{?>
							<a class="btn btn-danger btn-sm status_button" href="availavility.php?change=<?php echo $row["doctor_schedule_id"] ?>"  onclick="return confirm('Are you sure you want to Unavailable it?')">Unavailable</button>
						<?php }
						?></td>
