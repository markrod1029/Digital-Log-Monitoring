 ...
 <aside class="main-sidebar sidebar-dark-primary elevation-4" style="position:fixed;" >
    ...
    <div class="sidebar" >
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex" style="border-style:none;">
        <div class="image">
          <img src="<?php echo (!empty($user['patient_photo']))? '../images/'.$user['patient_photo']:'../images/profile.jpg'; ?>" class="img-circle elevation-2 d-flex " style="height:60px; width:60px; margin-left:60px;" >
        </div>
      </div>
