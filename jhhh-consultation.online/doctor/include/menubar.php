                    ...
                    <li class="nav-item dropdown no-arrow">
                        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                            ...
                            <img class="img-profile rounded-circle"
                                src="<?php echo (!empty($user['doctor_profile_image']))? '../images/'.$user['doctor_profile_image']:'../images/profile.jpg'; ?>" width="30" height="30" id="user_profile_image">
                        </a>
                        ...
                        <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                            ...
                            <a class="dropdown-item" href="php/logout.php?doctor_id=<?php echo $user['doctor_id']; ?>" >
