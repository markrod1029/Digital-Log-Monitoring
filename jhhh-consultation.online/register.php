  ...
  <body class="min-h-screen bg-gray-100 text-gray-900 flex justify-center">
      ...
      <h1 class="text-2xl xl:text-3xl font-extrabold">
        ...
        <div class="card">
                    ...
                    <form  method="POST" action="register_action.php" enctype="multipart/form-data" >
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" name="patient_email_address" id="patient_email_address" class="form-control" required autofocus data-parsley-type="email" data-parsley-trigger="keyup" />
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="patient_phone_no" id="patient_phone_no" minlength="11" maxlength="11" pattern="\d{11}" title="11-digit Phone Number" class="form-control" required  data-parsley-trigger="keyup" />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
              ...
              Do You have Account? <a href="index.php" class="link-info">Login here</a>
              </p>
            </div>
