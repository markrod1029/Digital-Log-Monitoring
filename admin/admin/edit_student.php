 ...
 ?>
            ...
            <form class="form-horizontal" method="POST" enctype="multipart/form-data" action = "crud/student_edit.php?id=<?php echo $row['id'];?>">
                ...
                <div class="input-group col-sm-8 col-xs-11">
                    ...
                    <input type="text" class="form-control" id="student_id" name="student_id" placeholder="Student ID Here"  value = "<?php echo $row['student_id'];?>" readonly>
                </div>
                </div>
                ...
                <div class="input-group mb-3 ">
                    ...
                    <div class="input-group-prepend"><span class="input-group-text"><i class="fa fa-user"></i></span></div>
                        <input type='tel' minlength="11" maxlength="11"  pattern="^09\d{9}$|^\+63\d{10}$" title="11-digit Start in 09 Phone Number" class="form-control" id="contact" name="contact"  value = "<?php echo $row['contact'];?>" placeholder="Contact No Here" 
                          required>
