...
<?php include 'includes/menu_bar.php';?>
  ...
  <section class="content-header">
    ...
    <div class="col-sm-6">
              ...
              <a href="add_student.php"  class="btn btn-primary  add mt-2"><i class="fa fa-plus"></i></a>
    ...
    <table id='studenttable' class='display dataTable table-bordered' style="width:100%;">
        ...
        <tbody>
          <?php 
                    ...
                    $sql = "SELECT *, student.id AS stid FROM student LEFT JOIN schedules ON schedules.id=student.schedule_id ORDER BY student.student_id ASC ";
                    ...
                    ?>
                        ...
                        <td>
                            ...
                            ?>
                            <img src="<?php echo $imageSrc; ?>" width="50px" height="50px">
                        </td>
                       ...
                       <td><center><img src="../../path/qrcode/<?= $row['student_id']; ?>.png" width="50px" height="50px"></center></td>
                        ...
                        <td><?php echo date('h:i A', strtotime($row['time_in_morning'])).' - '.date('h:i A', strtotime($row['time_out_morning'])).'<br>'.date('h:i A', strtotime($row['time_in_afternoon'])).' - '.date('h:i A', strtotime($row['time_out_afternoon'])); ?></td>
                            ...
                            <a href="student_information.php?id=<?php echo $row['stid'];?>" class="btn btn-success btn-sm  " style="margin-right: 5px;" ><i class="fa fa-eye"></i> </a>
                            <a href="edit_student.php?id=<?php echo $row['stid'];?>" class="btn btn-primary btn-sm  " style="margin-right: 5px;"><i class="fa fa-edit"></i> </a>
                            <a  name="delete" onclick="return confirm('Are you sure you want to remove this User?')" href="crud/student_delete.php?id=<?php echo $row['stid'];?>" class="btn btn-danger btn-sm  " ><i class="fa fa-trash"></i> </a>
                            </div>
                            </td> 
                        </tr>
                    <?php
