            ...
            <div class="row">
                <div class="col-lg-4 col-xlg-3">
                        <div div class="small-box bg-default" style ="background-color:white;">
                            <div class="card-body">
                                <center class="mt-4"> 
                                <img id="imageResult" height="150" width="150" src="<?php echo (!empty($user['photo'])) ? '../../images/'.$user['photo'] : '../../path/images/profile.jpg'; ?>" class="img-circle " alt="User Image" width="150">
