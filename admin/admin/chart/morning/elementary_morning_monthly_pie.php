...
<?php
 ...
 //  late 
  $sql = "SELECT DISTINCT student_id FROM monitoring_morning WHERE year = '$year' AND month = '$month' AND status_morning = 0  AND student = 'Elementary'";
 $query = $conn->query($sql);
 $late = $query->num_rows;
 // ontime
 
 $sql = "SELECT DISTINCT student_id FROM monitoring_morning WHERE   year = '$year' AND month = '$month'  AND status_morning = 1 AND student = 'Elementary'";
 $query = $conn->query($sql);
