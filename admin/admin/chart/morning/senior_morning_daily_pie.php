...
<?php
 ...
 //  late 
 $sql = "SELECT DISTINCT student_id FROM monitoring_morning WHERE date = '$today' AND status_morning = 0 AND student = 'Senior'";
 $query = $conn->query($sql);
 $late = $query->num_rows;
 
 $sql = "SELECT DISTINCT student_id FROM monitoring_morning WHERE date = '$today' AND status_morning = 1  AND student = 'Senior'";
 $query = $conn->query($sql);
