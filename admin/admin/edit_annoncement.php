          ...
          <div class="card">
            ...
            <div class="box-header with-border " style ="background-color:#367FA9;">
                ...
                <div class="card-header ">
                    <h4 class="card-title text-white title">Update a Announcement</h4>
                </div>
...
$ID = $_GET['id'];
 ...
 ?>
            ...
            <div class="card-body">
                ...
                <h4 class="card-title text-dark mb-3">Announcement Info</h4> <br>
                ...
                <div class="row ">
                    ...
                    <label for="fname" class="col-sm-2 text-right control-label col-form-label text-muted">Description of Announcement</label>
                    <div class="input-group col-sm-8 col-xs-11">
                        <div class="input-group-prepend"><span class="input-group-text"><i class="fa fa-user"></i></span></div>
                    ...
                    <label for="fname" class="col-sm-2 text-right control-label col-form-label text-muted">Start </label>
                    <div class="input-group col-sm-8 col-xs-11">
                        <div class="input-group-prepend"><span class="input-group-text"><i class="fa fa-user"></i></span></div>
                    ...
                    <label for="fname" class="col-sm-2 text-right control-label col-form-label text-muted">End </label>
                    <div class="input-group col-sm-8 col-xs-11">
                        <div class="input-group-prepend"><span class="input-group-text"><i class="fa fa-user"></i></span></div>
