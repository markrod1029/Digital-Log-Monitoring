<aside class="main-sidebar sidebar-dark-primary">
    <!-- Brand Logo -->
    <a href="index3.html" class="brand-link " style ="border-style:none; height:70px; " >
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav-treeview">
              <li class="nav-item has-treeview">
                ...
                <ul class="nav-treeview">
                  <li class="nav-item">
                    <a href="elementary_morning_daily.php" class="nav-link">Elementary Morning</a>
                  </li>
                  <li class="nav-item">
                    <a href="elementary_afternoon_daily.php" class="nav-link">Elementary Afternoon</a>
                  </li>
                </ul>
              </li>
            </ul>
            ...
            <ul class="nav-treeview">
              <li class="nav-item has-treeview">
                ...
                <ul class="nav-treeview">
                  <li class="nav-item">
                    <a href="junior_morning_daily.php" class="nav-link">Junior Morning</a>
                  </li>
                  <li class="nav-item">
                    <a href="junior_afternoon_daily.php" class="nav-link">Junior Afternoon</a>
                  </li>
                </ul>
              </li>
            </ul>
            ...
            <ul class="nav-treeview">
              <li class="nav-item has-treeview">
                ...
                <ul class="nav-treeview">
                  <li class="nav-item">
                    <a href="senior_morning_daily.php" class="nav-link">Senior Morning</a>
                  </li>
                  <li class="nav-item">
                    <a href="senior_afternoon_daily.php" class="nav-link">Senior Afternoon</a>
                  </li>
                </ul>
