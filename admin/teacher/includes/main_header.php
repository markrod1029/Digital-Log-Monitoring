...
<html>
<head>
  	<title>Digital Log Monitoring With Data Analytics</title>
  	<!-- Tell the browser to be responsive to screen width -->
      <meta charset="UTF-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <link rel="shortcut icon" type="image/x-icon" href="../../path/images/logo.png" />
    ...
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-EVSTQN3/azprG1Anm3QDgpJLIm9Nao0Yz1ztcQTwFspd3yD65VohhpuuCOmLASjC" crossorigin="anonymous">    
  	...
  	<!-- Theme style -->
		...
		<link rel="stylesheet" href="../../bower_components/DataTables/DataTables-1.12.1/css/dataTables.bootstrap.css">
