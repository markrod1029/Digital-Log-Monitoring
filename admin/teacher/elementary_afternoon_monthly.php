  ...
  <section class="content-header">
    ...
    <div class="col-sm-6">
                <ol class="breadcrumb float-sm-left">
                  ...
                  <li class="breadcrumb-item active"> /&nbsp;Elementary Afternoon</li>
      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <ul class="nav nav-pills custom-pills mb-2" style="font-size:17px;">
                            ...
                            <li class="nav-item">
                                <a class="nav-link " id="pills-timeline-tab"  href="elementary_afternoon_daily.php">Daily</a>
                            </li>

                      

                            <li class="nav-item">
                                <a class="nav-link show-btn" id="pills-setting-tab" style="border-bottom: solid 2px blue; color:#3C8DBC;"  href="elementary_afternoon_monthly.php"  style="  color:#3C8DBC;">Monthly</a>
                            </li>
        ...
        <div class="box-body">
            ...
            <?php include 'chart/afternoon/elementary_afternoon_monthly_bar.php'; ?>




<?php include 'chart/afternoon/elementary_afternoon_monthly_pie.php'; ?>
