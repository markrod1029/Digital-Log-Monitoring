          ...
          <div class="card">
            ...
            <table id='afternoon' class='display dataTable table-bordered' style="width:100%;">
              ...
              $student = $user['student'];
                   $sql = "SELECT *, student.student_id AS stid, monitoring_afternoon.id AS attid FROM monitoring_afternoon
                    LEFT JOIN student ON student.id=monitoring_afternoon.student_id 
                  WHERE monitoring_afternoon.schedule_id = '$student'
                     ORDER BY monitoring_afternoon.date DESC, monitoring_afternoon.time_in_afternoon DESC ";
