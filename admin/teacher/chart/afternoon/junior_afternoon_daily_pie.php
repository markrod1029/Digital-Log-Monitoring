...
<?php
 ...
 //  late 
 $sql = "SELECT DISTINCT student_id FROM monitoring_afternoon WHERE date = '$today' AND status_afternoon = 0  AND student = 'Junior'";
 $query = $conn->query($sql);
 $late = $query->num_rows;
 
 $sql = "SELECT DISTINCT student_id FROM monitoring_afternoon WHERE date = '$today' AND status_afternoon = 1  AND student = 'Junior'";
 $query = $conn->query($sql);
