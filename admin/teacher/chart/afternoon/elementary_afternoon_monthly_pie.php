...
<?php
 ...
 //  late 
  $sql = "SELECT DISTINCT student_id FROM monitoring_afternoon WHERE year = '$year' AND month = '$month' AND status_afternoon = 0  AND student = 'Elementary'";
 $query = $conn->query($sql);
 $late = $query->num_rows;
 // ontime
 
 $sql = "SELECT DISTINCT student_id FROM monitoring_afternoon WHERE   year = '$year' AND month = '$month'  AND status_afternoon = 1 AND student = 'Elementary'";
 $query = $conn->query($sql);
