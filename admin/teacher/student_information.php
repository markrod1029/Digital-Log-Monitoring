                ...
                <div class="col-lg-4 col-xlg-3">
                    ...
                    <div class="col-lg-8 col-xlg-3">
                        ...
                        <ul class="nav nav-pills custom-pills" style="font-size:17px;">
                            ...
                            <li class="nav-item">
                                <a class="nav-link " id="pills-timeline-tab" style="border-bottom: solid 2px blue; color:#3C8DBC;"  href="#">Profile</a>
                            </li>
                            ...
                            <li class="nav-item">
                                <a class="nav-link show-btn" id="pills-setting-tab" href="#"  style="  color:#3C8DBC;">Student History</a>
                            </li>
...
<div class="box-header with-border">
                        ...
                        <ul class="nav nav-pills custom-pills" style="font-size:17px;">
                            ...
                            <li class="nav-item">
                                    <a class="nav-link hide-btn" id="pills-timeline-tab" style="   " href="#">Profile</a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link" id="pills-setting-tab" href="#" style="border-bottom: solid 2px blue; color:#3C8DBC;">Security Setting</a>
                                </li>
...
<table id='' class='display dataTable table-bordered' style="width:100%;">
<thead>
<tr>
<th class="hidden"></th>
  <th>Date</th>
