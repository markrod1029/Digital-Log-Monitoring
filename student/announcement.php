                ...
                <section aria-label="Announcements" class="announcements">
                    ...
                    ?>
                            ...
                            <li class="border-bottom pb-4 ">
                                <h4 class="font-weight-bold mt-0  text-center">
                                        <a href="#" class="text-uppercase">
                                        <?php echo $row['title']?>
                                        </a>
                                    </h4>
                                    <center><span class="meta text-uppercase text-center"><?php echo date('M d, Y', strtotime($row['start_datetime'])). ' - '.date('M d, Y', strtotime($row['end_datetime']))?> </span>
                                    <p class="meta text-uppercase text-center"><?php echo date('h:i:s A', strtotime($row['start_datetime'])). ' - '.date('h:i:s A', strtotime($row['end_datetime']))?> </p></center>
