<?php include('header_dashboard.php'); ?>
    <body id="class_div" class=bg-image style="background: url(admin/images/bglogo.png)">
                     ...
                     <div class="row-fluid">
                        ...
                        <div class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
										<?php
											$mission_query = mysqli_query($conn,"select * from content where title  = 'Description' ")or die(mysqli_error());
								...
								<hr>
										<?php
											$mission_query = mysqli_query($conn,"select * from content where title  = 'policy' ")or die(mysqli_error());
											$mission_row = mysqli_fetch_array($mission_query);
											echo $mission_row['content'];
										?> 
                                </div>
