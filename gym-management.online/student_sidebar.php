<div class="span3" id="sidebar">
	...
	<?php echo $row['firstname']." ".$row['lastname']; ?>	
		...
		<ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
			<li class="active"><a href="dashboard_student.php"><i class="icon-chevron-right"></i><i class="icon-group"></i>&nbsp;My Classroom</a></li>
			<li class="">
			...
			<li class=""><a href="backpack.php"><i class="icon-chevron-right"></i><i class="icon-suitcase"></i>&nbsp;My Files</a></li>
		</ul>
