...
<?php $get_id = $_GET['id']; ?>
    <body class="bgdboard" style="background: url(admin/images/bgdboard.png)">
                     ...
                     <div class="row-fluid">
					    <!-- breadcrumb -->
					     ...
					     <ul class="breadcrumb">
							...
							<li><a href="#"><b>Downloaded Files</b></a></li>
						</ul>
						 <!-- end breadcrumb -->
                        ...
                        <div id="block_bg" class="block">
							...
							Check All <input type="checkbox"  name="selectAll" id="checkAll" />
								...
								<?php
									...
									$count = mysqli_num_rows($query);	
								if ($count == '0'){ ?>
								<div class="alert alert-info"><i class="icon-info-sign"></i> No downloaded files currently uploaded.</div>
								<?php
								}else{
								?>
