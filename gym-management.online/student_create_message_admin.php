<div class="span3" id="">
	<div class="row-fluid">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
								    ...
								    <ul class="nav nav-tabs">
										...
										<li class="active"><a href="student_message_admin.php">For Admin</a></li>
									</ul>
										...
										<div class="control-group">
                                          ...
                                          <div class="controls">
                                            <select name="teacher_id" class="chzn-select" required>
                                              	<option></option>
											<?php
											$query = mysqli_query($conn,"select * from users order by firstname");
			...
			jQuery("#send_message").submit(function(e){
					...
					$.ajax({
						type: "POST",
						url: "send_message_student_to_admin.php",
						data: formData,
