                        ...
                        <div class="block">
                            ...
                            <div class="block-content collapse in">
								...
								<form method="post">
                                        ...
                                        <div class="control-group">
                                          <div class="controls">
                                            <input name="adviser" value="<?php echo $row['adviser']; ?>" class="input focused" id="focusedInput" type="text" placeholder = "Adviser" required>
                                          </div>
                                        </div>
...
mysqli_query($conn,"update class set class_name = '$class_name', adviser = '$adviser'  where class_id = '$get_id' ")or die(mysqli_error());
?>
