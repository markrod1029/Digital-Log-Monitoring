<div class="span3" id="">
	<div class="row-fluid">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
									<ul class="nav nav-tabs">
										...
										<li class="active"><a href="admin_message_student.php">For Student</a></li>
								...
								<form method="post" id="send_message_admin_to_student">
			...
			jQuery("#send_message_admin_to_student").submit(function(e){
					e.preventDefault();
					var formData = jQuery(this).serialize();
					$.ajax({
						type: "POST",
						url: "send_message_admin_to_student.php",
						data: formData,
						success: function(html){
						
						$.jGrowl("Message Successfully Sended", { header: 'Message Sent' });
						var delay = 2000;
							setTimeout(function(){ window.location = 'admin_message_student.php'  }, delay);  
