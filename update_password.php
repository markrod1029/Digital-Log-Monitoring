...
<div class="login-box " style="box-shadow: 0 4px 8px 0 rgb(0 0 0 / 20%), 0 6px 20px 0 rgb(0 0 0 / 19%);  -webkit-box-shadow: 0 35px 20px #777;
  ...
  box-shadow: 0 35px 20px #777;">
             ...
             <span class="fa fa-user glyphicon-bordered"></span>
						...
						<h5 style=" margin-bottom:-20px; margin-top:7px; font-size:23px;">Update New Password</h5>
...
if (isset($_POST["update"]))
{
    ...
    $row = mysqli_fetch_object($result);
        ...
        if ($new_password == $confirm_password)
        {
                ...
                $update = "UPDATE student SET password='" . password_hash($new_password, PASSWORD_DEFAULT) . "',resettoken='NULL',resettokenexp=NULL WHERE email = '$email'";
